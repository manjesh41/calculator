...
b14=Button(root,text='%',font='lucid 20 bold',fg='red',bg='black',command=button_per)
...
b13.grid(column=0,row=5,pady=10,padx=10,ipadx=20,ipady=7)
b14.grid(column=1,row=5,pady=10,padx=10,ipadx=20,ipady=7)
b15.grid(column=2,row=5,pady=10,padx=10,ipadx=20,ipady=7)
b16.grid(column=0,row=6,pady=10,padx=10,ipadx=30 , ipady=7 )
b17.grid(column=1,row=6,columnspan=2,pady=10,padx=10,ipadx=30,ipady=7)
